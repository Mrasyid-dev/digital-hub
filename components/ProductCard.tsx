  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video overflow-hidden border-b-4 border-black bg-gray-100">
        ...
        />
        {/* Category Badge */}
        <div className="absolute top-3 left-3 font-pixel text-[8px]">
          <span className={`px-2 py-1.5 border-2 border-black text-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] ${
            isWedding 
              ? "bg-pink-600" 
              : "bg-emerald-600"
          }`}>
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-sm font-bold text-gray-800 mb-2 group-hover:text-emerald-600 transition-colors font-title line-clamp-1">
          {product.title}
        </h3>
        <p className="text-xs text-gray-500 line-clamp-2 mb-4 leading-relaxed font-mono">
          {product.description}
        </p>

        {/* Feature quick view (first 3) */}
        <ul className="space-y-2 mb-6 flex-grow font-mono">
        ...
        <div className="border-t-2 border-black pt-4 mt-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-2 text-[8px] font-pixel bg-gray-100 hover:bg-gray-200 text-gray-700 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:translate-x-[2px] active:shadow-none transition-all uppercase"
            >
            ...
            {product.demoUrl ? (
              <Link
                ...
                className={`flex items-center justify-center gap-1.5 px-3 py-2 text-[8px] font-pixel text-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:translate-x-[2px] active:shadow-none transition-all uppercase ${
                  isWedding 
